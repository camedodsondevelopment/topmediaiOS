...
//                if let structuredformatting = data["structured_formatting"] as? [String: Any] {
//                    object.secondText = structuredformatting["secondary_text"] as? String ?? ""
//                }
//                object.formattedAddress = address
//                object.placeId = pId
//            }
...
//                    finalParameters += "&radius=" + String(radius)
//                }
//                if let nextPage = input.nextPageToken{
//                    finalParameters += "&pagetoken=" + nextPage
//                }
//            }
